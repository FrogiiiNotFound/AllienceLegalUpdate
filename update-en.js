...
document.addEventListener('click', function (event) {
    if (event.target.classList.contains('header-link-1')) {
        ...
        if (window.location.pathname.includes('AllienceLegalSolutions-en.html')) {
            ...
            window.location.href = 'AllienceLegalSolutions-en.html#services';
        }
    }
});
...
document.addEventListener('click', function (event) {
    if (event.target.classList.contains('header-link-2')) {
        ...
        if (window.location.pathname.includes('AllienceLegalSolutions-en.html')) {
            ...
            window.location.href = 'AllienceLegalSolutions-en.html#team';
        }
    }
});
